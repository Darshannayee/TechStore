...
namespace TechStore.Repository
{
    public class GenericRepository<Tbl_Entity> : IRepository<Tbl_Entity> where Tbl_Entity : class
    {
        ...
        private TechStoreEntities _DBEntity;
        public GenericRepository(TechStoreEntities DBEntity)
        {
            _DBEntity = DBEntity;
        ...
        public IEnumerable<Tbl_Entity> GetAllRecordsIQueryable()
        {
            return _dbSet;
        }
        ...
        IQueryable<Tbl_Entity> IRepository<Tbl_Entity>.GetAllRecordsIQueryable()
        {
            return _dbSet;
        }
